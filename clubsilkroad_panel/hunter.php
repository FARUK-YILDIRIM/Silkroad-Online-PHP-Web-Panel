...
<style>
 ...
 <!--********************************************* Main start *********************************************-->
		...
		<div id="full_page_wrapper">
			...
			<div class="header">
				<h2><span><?php echo $gameName; ?> //</span> HUNTER RANK</h2>
			</div>
	...
	<h1><img style="margin-right:2%" src="./images/hunter.jpg" alt="" />Hunter Rank</h1>
	<!--- script --->
	...
	$playerrank = $users->link->db_conn_shard->query("SELECT TOP 25 Y.NickName16,X.Level,X.Exp FROM _CharTrijob X,_Char Y WHERE X.CharID=Y.CharID AND X.JobType=3 ORDER BY X.Contribution DESC");
	$rank = 1;
