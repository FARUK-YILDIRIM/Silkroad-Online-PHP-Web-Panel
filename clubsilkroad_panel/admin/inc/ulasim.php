...
<article class="module width_full">
	...
	<header><h3>ULAŞIM</h3></header>
	<div class="module_content">
	
		<p>*Mail Adreslerinizi-Telefon numaranızı burada belirtebilirsiniz.</p>
		...
		$query = $admin->link->db_conn_account->query("SELECT * FROM fy_contact ");
